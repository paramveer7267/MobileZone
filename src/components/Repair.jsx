...
const Repair = () => {
  ...
  const repairs = ["Screen", "Battery", "Camera", "Charging Port", "Others"];
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        setContactValue("");
        toast.success("Your repair request has been sent!");
      } else {
  ...
  return (
    <div className="mt-12 scroll-mt-24" id="repair">
      {/* Stepper */}
      <div className="relative flex justify-between items-center mb-12">
        ...
        {["Device Type", "Brand/Model", "Repair", "Cart"].map((label, idx) => {
          const num = idx + 1;
          return (
            <div
              key={idx}
          ...
          >
            ...
            <div className="max-w-md mx-auto bg-white p-6 rounded-xl shadow-md">
              <form
                onSubmit={(e) => {
                  e.preventDefault();
                  if (selectedBrand.trim()) setStep(3);
                }}
              >
                <input
                  type="text"
