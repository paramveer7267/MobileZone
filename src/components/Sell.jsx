...
const Sell = () => {
  ...
  const conditions = ["Like New", "Good", "Fair", "Broken", "Others"];
  ...
  const handleSubmit = async () => {
    ...
    const formData = {
      ...
      subject: "New Sell Request", // ✅ FIXED
    };
  ...
  return (
    <div className="mt-12 scroll-mt-24" id="sell">
      {/* Stepper */}
      <div className="relative flex justify-between items-center mb-12">
        ...
        {["Device Type", "Brand/Model", "Condition", "Quote"].map(
          (label, idx) => {
            const num = idx + 1;
            return (
              <div
        ...
        {step === 4 && (
          ...
          >
            ...
            <div className="bg-white max-w-2xl mx-auto rounded-xl shadow-md p-6 flex flex-col items-center">
              ...
              >
                {loading ? "Sending..." : "Get Final Quote"}
              </button>
